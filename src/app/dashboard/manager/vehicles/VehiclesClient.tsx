...
export default function VehiclesPage() {
    ...
    const getStateLabel = (state: VehicleState | string) => {
        const s = String(state);
        switch (s) {
            case 'IN_SERVICE':
            case VehicleState.IN_SERVICE:
                return t('vehicles.inService');
            case 'PARKED':
            case VehicleState.PARKED:
                return t('vehicles.parked');
            case 'IN_ALARM':
            case VehicleState.IN_ALARM:
                return t('vehicles.inAlarm');
            case 'UNDER_MAINTENANCE':
            case VehicleState.UNDER_MAINTENANCE:
                return t('vehicles.maintenance');
            case 'OUT_OF_SERVICE':
            case VehicleState.OUT_OF_SERVICE:
